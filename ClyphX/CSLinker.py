    ...
    def connect_script_instances(self, instanciated_scripts):
        ...
        if self._script_names:
            ...
            for script in instanciated_scripts:
                ...
                if (IS_LIVE_9_5 and script_name == 'PUSH') or (isinstance(script, ControlSurface) and script.components): 
            ...
            if found_scripts:
                ...
                for script in scripts:
                    if IS_LIVE_9_5 and script.__class__.__name__.upper() == 'PUSH':
                ...
                if len(ssn_comps) == 2:
                    ...
                    if self._matched_link:
                        ...
                        if IS_LIVE_9_5 and self._script_names[0] == 'PUSH':
